...
class GetRecordsCommandTest extends SapphireTest {
	 ...
	 */
	static $fixture_file = 'geonetwork/tests/GetRecordsCommandTest.yml';
	...
	function testGetRecordsInISOCommand() {
		...
		$position = strpos($result, '<csw:GetRecords xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" service="CSW" version="2.0.2" resultType="results" outputSchema="csw:IsoRecord" maxRecords="15" startPosition="5">');
	...
	function testDefaultValuesForPaging() {
		...
		$position = strpos($result, '<csw:GetRecords xmlns:csw="http://www.opengis.net/cat/csw/2.0.2" service="CSW" version="2.0.2" resultType="results" outputSchema="csw:IsoRecord" maxRecords="10" startPosition="0">');
