	...
	function getCMSFields() {
		...
		$fields->addFieldsToTab('Root.Content.Catalogue',
			array( 
				...
				new EmailField('SendConfitmationsTo', 'Where to send the confirmation emails to:'),
				new TextField('EmailName', 'The name of the person who receives the email:'),
...
class RegisterDataPage_Controller extends Page_Controller {
	...
	public function init() {
		parent::init();
		//Requirements::javascript("nzgo/javascript/jquery.validate.pack.js");
		Requirements::javascript("nzgo/javascript/metadata_form.js");
	...
	function doRegisterMetadata($data, $form) {
		...
		$emailValues = array(
			...
			"SendEmailSubject"	=> 'New Metadata registered by('. $contact->MDElectronicMailAddress .')' , 
